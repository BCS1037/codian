...
export class App {
  ...
  secretStorage: any = {
    setSecret: jest.fn((id: string, secret: string) => this.secrets.set(id, secret)),
    getSecret: jest.fn((id: string) => this.secrets.get(id) ?? null),
    listSecrets: jest.fn(() => Array.from(this.secrets.keys())),
  };
  vault: any = {
    adapter: {
...
export class SecretComponent {
  ...
  constructor(_app: any, _container: any) {}
