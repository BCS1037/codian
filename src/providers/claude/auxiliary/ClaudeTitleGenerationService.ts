...
import { resolveClaudeServiceLightweightSelection } from '../services/ClaudeThirdPartyServices';
...
export class TitleGenerationService {
  ...
  private resolveTitleModel(): string {
    ...
    if (titleModel && claudeChatUIConfig.ownsModel(
      ...
      return resolveClaudeServiceLightweightSelection(
        titleModel,
        getClaudeProviderSettings(this.plugin.settings).thirdPartyServices,
      );
    }
